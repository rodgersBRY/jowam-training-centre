...
export const courses: Course[] = [
    ...
    syllabus: [
      ...
      },
      {
        ...
        modules: [
          ...
          "Pouring foundations and free-pour control",
          "Latte art: heart, tulip, and rosetta patterns",
          "Consistency drills across drink sizes",
        ],
      },
      {
        week: 3,
        title: "Manual brewing methods",
        modules: [
          "V60 and pour-over technique",
          "Aeropress and immersion brewing",
          "French press and Chemex",
          "Recipe ratios, grind size, and extraction control",
        ],
      },
      {
        week: 4,
        title: "Customer service & hygiene",
        modules: [
      ...
      },
      {
        ...
        modules: [
          ...
          "Written and service evaluation",
  ...
  },
  {
    ...
    syllabus: [
      {
        week: 1,
        title: "Green bean selection & grading",
        modules: [
      ...
      },
      {
        ...
        modules: [
          ...
          "Reading and adjusting a roast curve",
        ],
      },
      {
        week: 3,
        ...
        modules: [
          ...
          "Reproducing profiles batch to batch",
        ],
      },
      {
        week: 4,
        title: "Cupping & sensory evaluation",
        modules: [
      ...
      {
        week: 5,
        title: "Assessment & business",
        modules: [
          "Practical roasting assessment",

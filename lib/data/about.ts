/**
 * Mission / vision / core values — net-new content authored for the
...
export const about = {
  ...
  values: [
    ...
    },
    {
      ...
      description:
        "Transparent pricing, realistic timelines, and a certificate that actually reflects what a graduate can do.",
    },
    {
